#!/usr/bin/env python3
"""Verify the exact final CLUE JLS2 v2 public-validation readiness lock."""
...
DEFAULT_LOCK = REPOSITORY / "config" / "clue-jls2-public-validation-v2-lock.json"
...
def verify_lock(
    ...
    *,
    ...
    if not lock_path.is_file():
        raise ValueError("final CLUE JLS2 v2 readiness lock is missing")
    lock = json.loads(lock_path.read_text(encoding="utf-8"))
    if lock.get("name") != LOCK_NAME:
        raise ValueError("unexpected CLUE JLS2 v2 readiness lock identity")
