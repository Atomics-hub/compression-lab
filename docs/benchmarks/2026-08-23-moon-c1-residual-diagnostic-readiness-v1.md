...
- Audited implementation commit: `f264c53da7d9d15aed1333efefcaabc113395793`
- Audited implementation tree: `acc6ce3385a0ea78aa3798e64a8dd69d3d028fa4`
...
test "$(git rev-parse f264c53da7d9d15aed1333efefcaabc113395793^{tree})" = 'acc6ce3385a0ea78aa3798e64a8dd69d3d028fa4'
git diff --exit-code f264c53da7d9d15aed1333efefcaabc113395793 -- native/src/bin/clab-moon-kernel.rs native/src/moon/c1.rs native/src/moon/c1_diagnose.rs native/src/moon/diagnose.rs native/src/moon/mod.rs native/Cargo.toml native/Cargo.lock
test "$(shasum -a 256 native/src/bin/clab-moon-kernel.rs | cut -d ' ' -f 1)" = 'a2fb6dcecd93762eec453d303410122cc254e90cdae00d440749cefb81e95490'
