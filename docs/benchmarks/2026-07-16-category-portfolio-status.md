...
| Source-code bundles | **10%** | Practical baseline, structural probe, sampled predictor ceiling, and exact long-range decomposition screen complete | ❌ Best explicit-LZP diagnostic produced 6,322,746 bytes versus Kanzi-max's 6,221,486 on CPython + TypeScript (1.63% larger) | ⚠️ exact diagnostic only: 3.41/2.89 MB/s versus Kanzi-max's 3.71/3.29 MB/s on this training subset | ⚠️ exact diagnostic only: 1,459.4/1,457.2 MiB versus Kanzi-max's 1,465.1/1,465.5 MiB | ❌ No; no Axiom prototype was admitted | Reject single-reference factorization; complete external research-ceiling hosts before freezing a genuinely stronger model combination ([chart](../../runs/text-source-long-range-screen-v1/publication/README.md)) |
| English Wikimedia wikitext | **10%** | Practical baseline, structural probe, sampled predictor ceiling, and exact long-range decomposition screen complete | ❌ Best explicit-LZP diagnostic produced 24,207,040 bytes versus Kanzi-max's 24,156,788 on Wikibooks + Wikinews (0.21% larger) | ⚠️ exact diagnostic only: 2.95/2.37 MB/s versus Kanzi-max's 2.38/2.15 MB/s on this training subset | ⚠️ exact diagnostic only: 1,527.4/1,523.1 MiB versus Kanzi-max's 1,529.5/1,525.8 MiB | ❌ No; no Axiom prototype was admitted | Reject single-reference factorization; complete external research-ceiling hosts and keep enwik9 diagnostic-only ([chart](../../runs/text-source-long-range-screen-v1/publication/README.md)) |
