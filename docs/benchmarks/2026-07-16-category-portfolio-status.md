...
| Source-code bundles | **10%** | Practical baseline complete | Kanzi-max leads at 45,550,471 bytes from 529,449,573 bytes (8.60%); Axiom untested | Leader measured at 3.47/2.95 MB/s compression/decompression | Leader measured at 1,890.5/1,909.7 MiB compression/decompression | ❌ No | Run the predeclared structural hypotheses and bounded research-ceiling tier ([chart](../../runs/text-source-development-baseline-census-v1/publication/README.md)) |
| English Wikimedia wikitext | **10%** | Practical baseline complete | Kanzi-max leads at 35,081,062 bytes from 201,311,173 bytes (17.43%); Axiom untested | Leader measured at 2.37/2.30 MB/s compression/decompression | Leader measured at 1,529.5/1,525.8 MiB compression/decompression | ❌ No | Run the structural hypothesis and bounded research-ceiling tier; keep enwik9 diagnostic-only ([chart](../../runs/text-source-development-baseline-census-v1/publication/README.md)) |
